...
if token:
    ...
    params = {
        ...
        '$filter': f"MlsStatus eq 'Closed' and CloseDate ge {datetime(2026, 7, 1).isoformat(timespec='milliseconds')}Z and CloseDate lt {datetime(2026, 8, 1).isoformat(timespec='milliseconds')}Z",
