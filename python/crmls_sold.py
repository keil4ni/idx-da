...
if token:
    ...
    params = {
        ...
        '$filter': f"MlsStatus eq 'Closed' and CloseDate ge {datetime(2026, 8, 1).isoformat(timespec='milliseconds')}Z and CloseDate lt {datetime(2026, 9, 1).isoformat(timespec='milliseconds')}Z",
    ...
    total_records = 0
    csv_file = 'CRMLSSold202608.csv'

    with open(folder / csv_file, mode='w', newline='', encoding='utf-8') as file:
