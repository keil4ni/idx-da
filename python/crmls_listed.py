...
if token:
    ...
    params = {
        ...
        '$filter': f"ListingContractDate ge {datetime(2026, 8, 1).isoformat(timespec='milliseconds')}Z and ListingContractDate lt {datetime(2026, 9, 1).isoformat(timespec='milliseconds')}Z",
    ...
    total_records = 0
    csv_file = 'CRMLSListing202608.csv'
